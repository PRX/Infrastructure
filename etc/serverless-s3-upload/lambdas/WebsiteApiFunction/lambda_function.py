...
def lambda_handler(event, context):
    ...
    post_policy_json_b64 = base64.b64encode(post_policy_json.encode("utf-8")).decode(
        "utf-8"
    )
        ...
        "body": json.dumps(
            {
                ...
                "bucket_domain_name": os.environ["BUCKET_DOMAIN_NAME"],
                "public_access_host": os.environ["PUBLIC_ACCESS_HOST"],
