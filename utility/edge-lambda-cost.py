...
STITCH_FUNCTION_NAME = 'us-east-1.infrastructure-cd-root-pr-DovetailStitchLambdaFunc-BZB7C5WUMFH6'
BYTES_FUNCTION_NAME = 'us-east-1.infrastructure-cd-root-pr-DovetailBytesLambdaFunct-18OYO33ARP2Z5'
...
for function in functions:
    ...
    for region in regions:
        ...
        print(f"{region} – Req: {requests} (${requests_cost}); Duration: {duration}ms (${duration_cost})")
