...
def post_notification_status(sns_message):
    ...
    build_url = (
        ...
        f"/codebuild/home#/builds/{build_id}/view/new"
    )
    ...
    if attrs["STATUS"]["Value"] == "true":
        ...
        attachment[
            "title"
        ] = f"<{build_url}|Built> {repo}{extra} with commit <{commit_url}|{sha7}>"
...
def log_build_metrics(sns_message):
    ...
    cloudwatch.put_metric_data(
        ...
        MetricData=[
            {
                "MetricName": "Builds",
                "Dimensions": [{"Name": "CodeBuildProject", "Value": project_name}],
                "Value": 1,
                "Unit": "Count",
            },
            {
            ...
            {
                "MetricName": "Builds",
                "Dimensions": [{"Name": "GitHubRepository", "Value": github_repo}],
                "Value": 1,
                "Unit": "Count",
            },
            {
